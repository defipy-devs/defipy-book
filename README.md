...
DeFiPy integrates seamlessly with **[`web3scout`](https://github.com/defipy-devs/web3scout)**,  
a lightweight extension of `web3.py` that provides efficient on-chain data fetching  
...
```bash
git clone https://github.com/defipy-devs/defipy-book-notebooks.git
...
```
Moore, I. (2025). *The DeFiPy Book: Deterministic Analytics for Decentralized Finance.*
ngeodesic-ai / defipy-devs, Apache-2.0.
```
